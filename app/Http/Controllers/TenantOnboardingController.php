...
class TenantOnboardingController extends Controller
{
    ...
    {
        abort_if($request->user()->tenants()->exists(), 403);

        return Inertia::render('Tenants/Create', [
            'suggestedName' => $request->user()->name.' — Organização',
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ...
            ->with('success', 'Organização criada. Configura a identidade e o acesso em poucos passos.');
    }
